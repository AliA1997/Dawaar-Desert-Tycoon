...
export const REGION_CHALLENGES: RegionChallenge[] = [
  ...
  },
  {
    ...
    title: 'South Asia',
    titleAr: 'جنوب آسيا',
    description: 'From the minarets of Kabul to the bazaars of Dhaka — conquer the heart of the Muslim world.',
    regionFlag: '🕌',
    color: '#1A2E1A',
    accentColor: '#4ADE80',
    countries: [
      {
        id: 'southasia_india',
        boardId: 'southasia_india',
        title: 'India',
        titleAr: 'الهند',
        flag: '🇮🇳',
        description: 'From Lucknow\'s Nawabi culture and Agra\'s Taj Mahal to the Char Minar of Hyderabad.',
        npcCount: 3,
        rewardPoints: 1000,
      },
      {
        id: 'southasia_pakistan',
        boardId: 'southasia_pakistan',
        title: 'Pakistan',
        titleAr: 'باكستان',
        flag: '🇵🇰',
        description: 'From Gwadar\'s deep-sea port and Multan\'s City of Saints to the vibrant streets of Karachi.',
        npcCount: 3,
        rewardPoints: 1000,
      },
      {
        id: 'southasia_bangladesh',
        boardId: 'southasia_bangladesh',
        title: 'Bangladesh',
        titleAr: 'بنغلاديش',
        flag: '🇧🇩',
        description: 'Navigate the river delta — from Cox\'s Bazar beaches to the bustling streets of Dhaka.',
        npcCount: 3,
        rewardPoints: 1000,
      },
      {
        id: 'southasia_afghanistan',
        boardId: 'southasia_afghanistan',
        title: 'Afghanistan',
        titleAr: 'أفغانستان',
        flag: '🇦🇫',
        description: 'From the ancient citadel of Ghazni and the blue mosque of Mazar-i-Sharif to Kabul.',
        npcCount: 3,
        rewardPoints: 1000,
      },
    ],
